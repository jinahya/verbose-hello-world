...
public interface HelloWorld {
     ...
     * set(array)} method with an array of {@link #BYTES} bytes and writes the
     * array to specified {@code stream} by invoking {@link
     ...
     * @implSpec The default implementation invokes {@link #set(byte[])
     * #set(array)} method with an array of {@link #BYTES} bytes and writes the
     * array to specified {@code data} by invoking {@link
     ...
     * @throws IOException          if an I/O error occurs.
     * @implSpec The default implementation invokes {@link #set(byte[])
     * #set(array)} with an array of {@link #BYTES} bytes and writes the array
     * to specified {@code file} by invoking {@code file.write(array)}.
     * @see #set(byte[])
     ...
     *                                 buffer.remaining} is less than {@link
     *                                 #BYTES}.
     ...
     * #put(buffer)} method with a byte buffer of {@link #BYTES} bytes, {@link
