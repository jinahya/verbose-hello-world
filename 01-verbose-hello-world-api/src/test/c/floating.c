...
int main(void) {
    ...
    MI("<float.h>", FLT_DIG, "fixed");
    MI("<float.h>", FLT_MIN_EXP, "fixed");
    MI("<float.h>", FLT_MAX_EXP, "fixed");
    MI("<float.h>", FLT_MIN_10_EXP, "fixed");
    MI("<float.h>", FLT_MAX_10_EXP, "fixed");
#ifdef FLT_DECIMAL_DIG
    MI("<float.h>", FLT_DECIMAL_DIG, "fixed");
#endif
    ...
    MI("<float.h>", DBL_DIG, "fixed");
    MI("<float.h>", DBL_MIN_EXP, "fixed");
    MI("<float.h>", DBL_MAX_EXP, "fixed");
    MI("<float.h>", DBL_MIN_10_EXP, "fixed");
    MI("<float.h>", DBL_MAX_10_EXP, "fixed");
#ifdef DBL_DECIMAL_DIG
    MI("<float.h>", DBL_DECIMAL_DIG, "fixed");
#endif
