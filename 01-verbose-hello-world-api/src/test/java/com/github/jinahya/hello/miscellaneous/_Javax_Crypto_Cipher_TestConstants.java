...
public final class _Javax_Crypto_Cipher_TestConstants {
     ...
     */
    @LatestLTS
    public static final Map<String, List<Object>> TRANSFORMATIONS_AND_KEYSIZES_LATEST_LTS =
            Map.ofEntries(
     ...
     */
    @LatestJDK
    public static final Map<String, List<Object>> TRANSFORMATIONS_AND_KEYSIZES_LATEST_JDK =
            Map.ofEntries(
                    Map.entry("AES/CBC/NoPadding", List.of(128)),
                    Map.entry("AES/CBC/PKCS5Padding", List.of(128)),
                    Map.entry("AES/ECB/NoPadding", List.of(128)),
