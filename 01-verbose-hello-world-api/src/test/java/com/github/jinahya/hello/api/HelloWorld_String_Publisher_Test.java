 ...
 */
@Slf4j
class HelloWorld_String_Publisher_Test extends HelloWorld__Publisher_Test<String> {
    ...
    void __random() { // @formatter:off
        ...
        final var subscriber = loggingSpy(new Flow.Subscriber<String>() {
            @Override public void onSubscribe(final Flow.Subscription s) { s.request(n); }
        ...
        final var expected = new String(hello_world_byte_array(), StandardCharsets.US_ASCII);
