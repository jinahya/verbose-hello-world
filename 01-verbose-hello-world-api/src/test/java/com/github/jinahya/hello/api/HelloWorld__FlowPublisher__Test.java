...
@Slf4j
abstract class HelloWorld__FlowPublisher__Test<T extends Flow.Publisher<U>, U> {

    HelloWorld__FlowPublisher__Test(final Function<? super HelloWorld, ? extends T> initializer) {
        super();
