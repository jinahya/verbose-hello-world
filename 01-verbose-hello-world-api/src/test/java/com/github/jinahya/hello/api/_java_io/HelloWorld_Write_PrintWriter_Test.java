...
/**
 * A class for testing {@link HelloWorld#write(PrintWriter) write(writer)} method.
 *
 * @author Jin Kwon &lt;onacit_at_gmail.com&gt;
 * @see <a
 * href="https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/io/PrintWriter.html">java.io.PrintWriter</a>
 */
@DisplayName("write(PrintWriter)")
...
class HelloWorld_Write_PrintWriter_Test
    ...
    /**
     * Verifies that the {@link HelloWorld#write(PrintWriter)} method invokes
    ...
    void __() throws IOException {
        ...
        final var writer = Mockito.mock(PrintWriter.class);
        // ------------------------------------------------------------------------------------ when
