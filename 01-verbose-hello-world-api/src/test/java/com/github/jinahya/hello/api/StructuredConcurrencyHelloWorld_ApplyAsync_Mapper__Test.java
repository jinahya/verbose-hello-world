...
class StructuredConcurrencyHelloWorld_ApplyAsync_Mapper__Test
        extends AsynchronousHelloWorld__Test<HelloWorld, StructuredConcurrencyHelloWorld<HelloWorld>> {

    // ---------------------------------------------------------------------------------------------
    StructuredConcurrencyHelloWorld_ApplyAsync_Mapper__Test() {
        super(HelloWorld.class, s -> new StructuredConcurrencyHelloWorld<>(s, java.util.function.UnaryOperator.identity()));
    }
