...
@DisplayName("ExecutorHelloWorld.append(Path, Attachment)")
class ExecutorHelloWorld_Append_Path_Attachment_Test
        extends AsynchronousHelloWorld_Append_Path_Attachment_Test<
        ExecutorHelloWorld<HelloWorld>
        > {

    ExecutorHelloWorld_Append_Path_Attachment_Test() {
