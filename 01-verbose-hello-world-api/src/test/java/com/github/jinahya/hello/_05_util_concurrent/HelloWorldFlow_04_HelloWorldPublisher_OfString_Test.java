...
class HelloWorldFlow_04_HelloWorldPublisher_OfString_Test extends _HelloWorldFlow_Test {
    ...
    void __() {
        ...
        final var publisher = new HelloWorldFlow.HelloWorldPublisher.OfString(service, EXECUTOR);
        final var subscriber = new HelloWorldFlow.HelloWorldSubscriber.OfString() { // @formatter:off
