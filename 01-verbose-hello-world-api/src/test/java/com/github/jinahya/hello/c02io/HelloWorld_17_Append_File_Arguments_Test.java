...
/**
 * A class for testing {@link HelloWorld#append(File) append(file)} method regarding arguments
 * verification.
 *
 * @author Jin Kwon &lt;onacit_at_gmail.com&gt;
 * @see HelloWorld_17_Append_File_Test
 */
@DisplayName("append(file) arguments")
@Slf4j
class HelloWorld_17_Append_File_Arguments_Test extends _HelloWorldTest {
