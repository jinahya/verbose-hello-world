...
class HelloWorld_SetCharacterStream_PreparedStatement_Int__Test
    ...
    class H2_Test {
        ...
        private static final String URL
                = "jdbc:h2:mem:setcharacterstream_preparedstatement_int_testdb;DB_CLOSE_DELAY=-1";
            ...
            try (var connection = DriverManager.getConnection(URL, USER, PASSWORD)) {
                ...
                }
                {
                    ...
                    try (var statement = connection.prepareStatement(sql)) {
                        service().setCharacterStream(statement, 1);
    ...
    class Hsql_Test {
        ...
        private static final String URL
                = "jdbc:hsqldb:mem:setcharacterstream_preparedstatement_int_testdb";
