...
/**
 * A class for exploring {@link com.github.jinahya.hello.api.HelloWorld#setBinaryStream(Blob, long)
 * setBinaryStream(blob, pos)} method with real {@link Blob} implementations from JDBC drivers.
 *
...
class HelloWorld_SetBinaryStream_Blob_Long__Test
    ...
    class H2_Test {
        ...
        private static final String URL
                = "jdbc:h2:mem:setbinarystream_blob_long_testdb;DB_CLOSE_DELAY=-1";
    ...
    class Hsql_Test {
        ...
        private static final String URL = "jdbc:hsqldb:mem:setbinarystream_blob_long_testdb";
