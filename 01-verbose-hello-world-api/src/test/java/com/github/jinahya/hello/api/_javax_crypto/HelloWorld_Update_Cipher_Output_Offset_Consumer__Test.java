...
/**
 * A class for exploring {@link HelloWorld#update(Cipher, byte[], int, IntConsumer)
 * update(cipher, output, outputOffset, outputLengthConsumer)} method with real {@link Cipher}
 * transformations.
 */
...
class HelloWorld_Update_Cipher_Output_Offset_Consumer__Test extends HelloWorld__Test {
    ...
    private static void print(final String transformation, final Object parameter,
                              final byte[] output, final int offset, final int bytes) {
        final var encrypted = Arrays.copyOfRange(output, offset, offset + bytes);
    ...
    void __stubService() throws ShortBufferException {
        doAnswer(i -> {
            ...
            final var output = i.getArgument(1, byte[].class);
            final var offset = i.getArgument(2, Integer.class);
            final var consumer = i.getArgument(3, IntConsumer.class);
            consumer.accept(cipher.update(hello_world_byte_array(), 0, HelloWorld.BYTES,
                                          output, offset));
            return cipher;
        }).when(service()).update(notNull(), notNull(), anyInt(), notNull());
    }
    ...
    void __AES_CBC_NoPadding(final int keysize) throws Exception {
        ...
        final var offset = 0;
        final var output = new byte[offset + cipher.getOutputSize(HelloWorld.BYTES) * 2];
        // ------------------------------------------------------------------------------------ when
        service().update(cipher, output, offset, b -> {
            // pad the input to a block boundary so NoPadding accepts doFinal
            final var pad = new byte[cipher.getBlockSize()
                                     - HelloWorld.BYTES % cipher.getBlockSize()];
            try {
                b += cipher.update(pad, 0, pad.length, output, offset + b);
                b += cipher.doFinal(output, offset + b);
                print("AES/CBC/NoPadding", keysize, output, offset, b);
    ...
    void __AES_CBC_PKCS5Padding(final int keysize) throws Exception {
        ...
        service().update(cipher, output, offset, b -> {
            try {
                b += cipher.doFinal(output, offset + b);
                print("AES/CBC/PKCS5Padding", keysize, output, offset, b);
            } catch (final Exception e) {
                throw new RuntimeException(e);
            }
        });
    ...
    void __AES_ECB_NoPadding(final int keysize) throws Exception {
        ...
        service().update(cipher, output, offset, b -> {
            ...
            try {
                b += cipher.update(pad, 0, pad.length, output, offset + b);
                b += cipher.doFinal(output, offset + b);
                print("AES/ECB/NoPadding", keysize, output, offset, b);
            } catch (final Exception e) {
                throw new RuntimeException(e);
            }
        });
    ...
    void __AES_ECB_PKCS5Padding(final int keysize) throws Exception {
        ...
        service().update(cipher, output, offset, b -> {
            try {
                b += cipher.doFinal(output, offset + b);
                print("AES/ECB/PKCS5Padding", keysize, output, offset, b);
            } catch (final Exception e) {
                throw new RuntimeException(e);
            }
        });
    ...
    void __AES_GCM_NoPadding(final int keysize) throws Exception {
        ...
        service().update(cipher, output, offset, b -> {
            try {
                b += cipher.doFinal(output, offset + b);
                print("AES/GCM/NoPadding", keysize, output, offset, b);
            } catch (final Exception e) {
                throw new RuntimeException(e);
            }
        });
    ...
    void __ChaCha20_Poly1305() throws Exception {
        ...
        service().update(cipher, output, offset, b -> {
            try {
                b += cipher.doFinal(output, offset + b);
                print("ChaCha20-Poly1305", null, output, offset, b);
            } catch (final Exception e) {
                throw new RuntimeException(e);
            }
        });
    ...
    void __DESede_CBC_NoPadding(final int keysize) throws Exception {
        ...
        service().update(cipher, output, offset, b -> {
            ...
            try {
                b += cipher.update(pad, 0, pad.length, output, offset + b);
                b += cipher.doFinal(output, offset + b);
                print("DESede/CBC/NoPadding", keysize, output, offset, b);
            } catch (final Exception e) {
                throw new RuntimeException(e);
            }
        });
    ...
    void __DESede_CBC_PKCS5Padding(final int keysize) throws Exception {
        ...
        service().update(cipher, output, offset, b -> {
            try {
                b += cipher.doFinal(output, offset + b);
                print("DESede/CBC/PKCS5Padding", keysize, output, offset, b);
            } catch (final Exception e) {
                throw new RuntimeException(e);
            }
        });
    ...
    void __DESede_ECB_NoPadding(final int keysize) throws Exception {
        ...
        service().update(cipher, output, offset, b -> {
            ...
            try {
                b += cipher.update(pad, 0, pad.length, output, offset + b);
                b += cipher.doFinal(output, offset + b);
                print("DESede/ECB/NoPadding", keysize, output, offset, b);
            } catch (final Exception e) {
                throw new RuntimeException(e);
            }
        });
    ...
    void __DESede_ECB_PKCS5Padding(final int keysize) throws Exception {
        ...
        service().update(cipher, output, offset, b -> {
            try {
                b += cipher.doFinal(output, offset + b);
                print("DESede/ECB/PKCS5Padding", keysize, output, offset, b);
            } catch (final Exception e) {
                throw new RuntimeException(e);
            }
        });
    ...
    void __PBEWithHmacSHA256AndAES_128() throws Exception {
        ...
        service().update(cipher, output, offset, b -> {
            try {
                b += cipher.doFinal(output, offset + b);
                print("PBEWithHmacSHA256AndAES_128", null, output, offset, b);
            } catch (final Exception e) {
                throw new RuntimeException(e);
            }
        });
    ...
    void __PBEWithHmacSHA256AndAES_256() throws Exception {
        ...
        service().update(cipher, output, offset, b -> {
            try {
                b += cipher.doFinal(output, offset + b);
                print("PBEWithHmacSHA256AndAES_256", null, output, offset, b);
            } catch (final Exception e) {
                throw new RuntimeException(e);
            }
        });
    ...
    void __RSA_ECB_PKCS1Padding(final int keysize) throws Exception {
        ...
        service().update(cipher, output, offset, b -> {
            try {
                b += cipher.doFinal(output, offset + b);
                print("RSA/ECB/PKCS1Padding", keysize, output, offset, b);
            } catch (final Exception e) {
                throw new RuntimeException(e);
            }
        });
    ...
    void __RSA_ECB_OAEPWithSHA_1AndMGF1Padding(final int keysize) throws Exception {
        ...
        service().update(cipher, output, offset, b -> {
            try {
                b += cipher.doFinal(output, offset + b);
                print("RSA/ECB/OAEPWithSHA-1AndMGF1Padding", keysize, output, offset, b);
            } catch (final Exception e) {
                throw new RuntimeException(e);
            }
        });
    ...
    void __RSA_ECB_OAEPWithSHA_256AndMGF1Padding(final int keysize) throws Exception {
        ...
        service().update(cipher, output, offset, b -> {
            try {
                b += cipher.doFinal(output, offset + b);
                print("RSA/ECB/OAEPWithSHA-256AndMGF1Padding", keysize, output, offset, b);
            } catch (final Exception e) {
                throw new RuntimeException(e);
            }
        });
