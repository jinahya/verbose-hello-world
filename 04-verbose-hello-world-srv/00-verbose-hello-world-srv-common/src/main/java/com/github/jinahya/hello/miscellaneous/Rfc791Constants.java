 ...
 * .
 *
 * @see <a href="https://www.rfc-editor.org/rfc/rfc791">RFC 791 INTERNET PROTOCOL</a>
 */
public final class Rfc791Constants {
    ...
    public static final int HEADER_TYPE_OF_SERVICE_SIZE = HEADER_DSCP_SIZE + HEADER_ECN_SIZE;
    ...
    public static final int HEADER_FRAGMENT_OFFSET_SIZE = Short.SIZE - HEADER_FLAGS_SIZE;
    ...
    public static final int HEADER_PADDING_SIZE = Integer.SIZE - HEADER_OPTIONS_SIZE;
    ...
    public static final int MAX_HEADER_SIZE =
            MIN_HEADER_SIZE + ((HEADER_IHL_MAX_VALUE - HEADER_IHL_MIN_VALUE) << 5);
