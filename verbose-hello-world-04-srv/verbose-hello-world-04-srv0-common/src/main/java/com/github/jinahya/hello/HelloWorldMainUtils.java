...
@Slf4j
final class HelloWorldMainUtils {
    ...
    /**
     * Connects to specified socket address and reads {@value HelloWorld#BYTES} bytes and
     ...
     * HelloWorld#BYTES} bytes and prints it as a {@link StandardCharsets#US_ASCII US-ASCII}
     ...
     * {@value HelloWorld#BYTES} bytes and prints it as a {@link StandardCharsets#US_ASCII
