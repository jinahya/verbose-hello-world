...
class HelloWorld_01_Set_Array_Arguments_Test
    ...
    /**
     * Asserts {@link HelloWorld#set(byte[]) set(array)} method throws a {@link NullPointerException} when the {@code
     * array} argument is {@code null}.
     */
    ...
    /**
     * Asserts {@link HelloWorld#set(byte[]) set(array)} method throws an {@link IndexOutOfBoundsException} when {@code
