 ...
 * A sequence of {@value com.github.jinahya.hello.HelloWorld#BYTES} bytes, representing the "{@code
 * hello, world}" string encoded in {@link java.nio.charset.StandardCharsets#US_ASCII US-ASCII}
 * character set, which consists of {@code 0x68('h')} followed by {@code 0x65('e')}, {@code
 * 0x6C('l')}, {@code 0x6C('l')}, {@code 0x6F('o')}, {@code 0x2C(',')}, {@code 0x20(' ')}, {@code
 * 0x77('w')}, {@code 0x6F('o')}, {@code 0x72('r')}, {@code 0x6C('l')}, and {@code 0x64('d')}.
 *
...
public interface HelloWorld {
     ...
     * array of {@value com.github.jinahya.hello.HelloWorld#BYTES} bytes and writes the array to
     * specified {@code stream} by invoking {@link OutputStream#write(byte[]) stream.write(array)}.
     * @see #set(byte[])
     ...
     * @implSpec The default implementation invokes {@link #set(byte[]) #set(array)} method with an
     * array of {@value com.github.jinahya.hello.HelloWorld#BYTES} bytes and writes the array to
     * specified {@code data} by invoking {@link DataOutput#write(byte[]) data.write(array)}.
     * @see #set(byte[])
     ...
     * of {@value com.github.jinahya.hello.HelloWorld#BYTES} bytes and writes the array to specified
     * {@code file} by invoking {@code file.write(array)}.
     * @see #set(byte[])
     ...
     * buffer's position, on successful return, is incremented by {@value
     ...
     * {@link ByteBuffer#position(int) position} by {@value com.github.jinahya.hello.HelloWorld#BYTES}.
     * Otherwise, this method invokes {@link #set(byte[]) #set(array)} method with an array of
     * {@value com.github.jinahya.hello.HelloWorld#BYTES} bytes and puts the array on the buffer by
     * invoking {@link ByteBuffer#put(byte[]) buffer.put(array)} which increments the {@code
     * buffer.position} by itself.
     ...
     * with a byte buffer of {@value com.github.jinahya.hello.HelloWorld#BYTES} bytes, {@link
     * ByteBuffer#flip() flips} the {@code buffer}, and writes the buffer to {@code channel} by
     * invoking {@code channel#write(buffer)} while the {@code buffer} has {@link
     ...
     * size of specified path, on successful return, is increased by {@value
     * com.github.jinahya.hello.HelloWorld#BYTES}.
     *
     ...
     * @implSpec The default implementation invokes {@link #put(ByteBuffer) #put(buffer)} method
     * with a byte buffer of {@value com.github.jinahya.hello.HelloWorld#BYTES} bytes, {@link
     * ByteBuffer#flip() flips} it, and write the buffer to specified channel by repeatedly invoking
     * {@link AsynchronousByteChannel#write(ByteBuffer) channel(buffer)} and {@link Future#get()
     * getting} the result while the {@code buffer} has {@link ByteBuffer#hasRemaining()
     * remaining}.
     */
     ...
     * @implSpec The default implementation invokes {@link #put(ByteBuffer) #put(buffer)} method
     * with a byte buffer of {@value com.github.jinahya.hello.HelloWorld#BYTES} bytes, {@link
     * ByteBuffer#flip() flips} it, and writes the buffer to specified channel by repeatedly
     * invoking {@link AsynchronousFileChannel#write(ByteBuffer, long) write(buffer,
     * adjusted-position)} and {@link Future#get() getting} the result.
     * @see #put(ByteBuffer)
     ...
     * @implSpec The default implementation invokes {@link #put(ByteBuffer) #put(buffer)} method
     * with a byte buffer of {@value com.github.jinahya.hello.HelloWorld#BYTES} bytes, {@link
     * ByteBuffer#flip() flips} it, and repeatedly invokes {@link AsynchronousFileChannel#write(ByteBuffer,
     * long, Object, CompletionHandler) channel#write(buffer, position, position,
     * self-invoking-handler)} method while the buffer has {@link ByteBuffer#remaining()
     * remaining}.
     * @see #write(AsynchronousFileChannel, long)
     */
